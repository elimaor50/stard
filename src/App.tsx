        ...
        <section id="contact" className="contact">
          ...
          <div className="contact-details">
            ...
            <div className="contact-social">
              ...
              <a href="https://www.instagram.com/stard.austria/" target="_blank" rel="noopener noreferrer" className="social-link" aria-label="Instagram" onClick={(e) => { e.preventDefault(); window.location.href = "instagram://user?username=stard.austria"; setTimeout(() => { window.open("https://www.instagram.com/stard.austria/", "_blank"); }, 500); }}>
