        ...
        <section id="contact" className="contact">
          ...
          <div className="contact-details">
            ...
            <div className="contact-social">
              ...
              <a href="https://www.instagram.com/stard.austria/" rel="noopener noreferrer" className="social-link" aria-label="Instagram" onClick={(e) => { const isIOS = /iphone|ipad|ipod/i.test(navigator.userAgent); if (isIOS) { e.preventDefault(); window.location.href = "instagram://user?username=stard.austria"; setTimeout(() => { window.location.href = "https://www.instagram.com/stard.austria/"; }, 800); } }}>
